...
if (strlen($data_schet)==0){ echo datetostring($schetfactura_date->date);} else { echo $data_schet;}?>
 ...
 <tr>
 <td width=2100px> Договор(контракт) на поставку товаров (работ, услуг) №<u><?php if ($firm->dog_real2<>null) {echo $firm->dog_real2;} else{ echo $firm->dogovor."        </u> от <u>       ".datetostring($firm->dogovor_date);}?>                 </u></td>
 <td> (3)</td>
 </tr>
 <tr>
 ...
 <TR>
  ...
  <TR>
	...
	<TR>
		...
		if ($is_light == 1)
		{
		echo "Электроэнергия для уличного освещения за <br/>".datetostring2($schetfactura_date->date) ."года" ;
		} else 
		{
		echo "Электроэнергия за <br/>".datetostring2($schetfactura_date->date) ."года" ;
		}
...
<?php endfor;?>
 ...
 <?php echo num2str(f_d2($sum_bez_nds + $sum_nds));?>
	...
	<tr>
	<td align=left><?php echo $org->director; ?>____________</td><td align=right>Техник по учету Фельцан С.И. ___________________</td>
	</tr>
	<tr>
