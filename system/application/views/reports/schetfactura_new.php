...
if (strlen($data_schet)==0){ echo datetostring($schetfactura_date->date);} else { echo datetostring($data_schet);}?>
 </td>
 <td ></td>
 </tr>
 <tr><td></td><td></td></tr>
 ...
 <tr>
 <td width=2100px>Тауарлар (жұмыстар, қызметтер) жеткізуге арналған шарт (келісім-шарт)<br/>Договор(контракт) на поставку товаров (работ, услуг) №<u>   <?php if (strlen($dog_real2)=='') {echo $firm->dogovor."   </u> от <u>    ".datetostring($firm->dogovor_date);} else echo $dog_real2;?></u></td>
 <td> (3)</td>
 </tr>
 <tr>
 ...
 <tr>
 <td width=2100px>Алушының ЖСК<br/> ИИК получателя<u>   <?php echo $firm->raschetnyy_schet;?></u> в банке <u><?php echo $bank->name;?></u> БИК<u> <?php echo $bank->mfo;?></u></td>
 <td> (10б)</td>
 </tr>
 </table>
 <br>
...
<tr align="center">
	...
	<TD width="400px"><?php if (strlen($firm->electric)==0) { echo "Электроэнергия за <br/>".datetostring2($schetfactura_date->date) ."года" ;} else {echo $firm->electric; }?></td>
	<TD width="100px">КВТ.Ч </td>
	<TD width="200px"><?php echo f_d($s2->kvt); $sum_kvt+=$s2->kvt;?></td>
	<TD width="100px"><?php echo f_d4($s2->tariff_value);?></td>
	...
	<?php
		if ($i_nds-$s2->nds_value>0)
		{
			...
			{echo f_d($posl*12/100);$sumnds=(f_d($posl*12/100))+$sumnds;}
	?>
	</td>
...
<br />
 ...
 <td></td>
 <td align="right"><b>БЕРДІ (жеткізушінің жауапты тұлғасы)<br/>ВЫДАЛ (ответственное лицо поставщика)<br/>Техник по учету Фельцан С.И. </b></td>
  </tr>
 <tr>
 <td> </td>
 <td align= "center">
