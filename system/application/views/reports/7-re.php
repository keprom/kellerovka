...
?>
		<table width=100% border=1px cellspacing=0px style="border: black;font-family: Verdana; font-size: xx-small;">
			<tr align=center>
				<td rowspan=2> № Дог. </td>
				<td rowspan=2 width=200px> Наименование потребителя </td>
				<td colspan=2> На начало отчетного периода </td>
				<td rowspan=2> Начислено </td>
				<td rowspan=2> Оплачено, всего </td>
				<td colspan=2> На конец периода </td>
				<td rowspan=2> Кол-во кВт/ч </td>
			</tr>
			<tr align=center>
				<td> Дебет </td>
				<td> Кредит </td>
		...
		<center>
			<table>
				...
				<tr>
					...
					<td width=150px></td>
					<td>
						<?php echo trim($org_info->nachalnik_otdela_sbyta);?>
					</td>
				</tr>
			</table>
		</center>
