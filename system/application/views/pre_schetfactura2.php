...
Договор реальный <input name=dog_real2  value='<?php echo $firm->dog_real2; ?>'> <br> <br>
Если уличное освещение <input name=electric  value='<?php echo $firm->electric; ?>'> <br> <br>
