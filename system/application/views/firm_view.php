...
<?php
if ($r->dog_real=="0"){
echo ($is_closed->closed=='t'?"<font color=red>":"").$r->dogovor."  ".$r->name.($is_closed->closed=='t'?"</font>":"");} else 
 echo ($is_closed->closed=='t'?"<font color=red>":"").$r->dog_real."  ".$r->name.($is_closed->closed=='t'?"</font>":"");?>
<br>
